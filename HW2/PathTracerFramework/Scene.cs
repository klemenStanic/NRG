...
namespace PathTracer
{
    public class Scene
    {
        ...
        public static Scene CornellBox()
        {
            ...
            //s.Elements.Add(new DiffuseAreaLight(new Disk(80, 0.1, Transform.Translate(278, 548, 280).A(Transform.RotateX(90))), Spectrum.Create(1), 20, false));
            s.Elements.Add(new DiffuseAreaLight(new Sphere(80, Transform.Translate(278, 450, 300)), Spectrum.Create(1), 12));


            el = new Sphere(100, Transform.Translate(150, 100, 420));
            el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.Blue), 70));
            s.Elements.Add(el);
            ...
            el.BSDF.Add(new OrenNayar(Spectrum.ZeroSpectrum.FromRGB(Color.Yellow), 40));
            s.Elements.Add(el);

            return s;

        }
        public static Scene CornellBoxSpatial()
        {
            var s = new Scene()
            {
                CameraOrigin = new Vector3(278, 204.4, -500),
                AspectRatio = 1.0 / 1.0,
                ImagePlaneWidth = 5.5
            };
            ...
            s.Elements.Add(new DiffuseAreaLight(new Sphere(1500, Transform.Translate(0, 0, 0)), Spectrum.Create(1), 1, true));

            el = new Sphere(100, Transform.Translate(100, 100, 420));
            el.BSDF.Add(new Lambertian(Spectrum.ZeroSpectrum.FromRGB(Color.Green)));
            s.Elements.Add(el);

            el = new Sphere(100, Transform.Translate(300, 100, 200));
            el.BSDF.Add(new Lambertian(Spectrum.ZeroSpectrum.FromRGB(Color.Chocolate)));
            s.Elements.Add(el);

            el = new Sphere(100, Transform.Translate(500, 100, 420));
            //el.BSDF.Add(new MicrofacetReflection(Spectrum.ZeroSpectrum.FromRGB(Color.White), 1.5, 1, 0.05));
            //el.BSDF.Add(new SpecularReflection(Spectrum.ZeroSpectrum.FromRGB(Color.White),0,0));
            //el.BSDF.Add(new SpecularReflection(Spectrum.ZeroSpectrum.FromRGB(Color.White),1,1.5));
            //el.BSDF.Add(new SpecularTransmission(Spectrum.ZeroSpectrum.FromRGB(Color.White), 1, 1.5));
